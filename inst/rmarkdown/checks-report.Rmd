...
### Saknade KTH-"org_code"-värden `r stats("missing_org_codes")`

```{r}
myDT(checks$missing_org_codes)
```
...
KuraTHor kontrollerar DiVA-organisationer för KTH som verkar sakna "org_code", en nyckel för KTHs internal organisationsenhet som används i andra KTH-system (Agresso/HR) och mappar DiVAs organisationer till KTHs.
