...
* inte inleds med `A1` eller `000` (tre nollor) 

> Exempel på korrekta ISI: `000642153100001` eller `A1975AU56200018` 
...
> Exempel på korrekta ORCID: `0000-0003-3455-0855` eller `0000-0003-5498-659X`
...
*Felaktigt använt ISBN* 

KuraTHor fångar upp poster av publikationstypen bokkapitel, konferensbidrag eller artikel som har ett ISBN inlagt i fältet för ISBN. Enskilda bokkapitel, konferensbidrag och artiklar ska inte ha något värde i fältet för ISBN, istället anges ISBN på den publikation (bok, konferenshandling) som postens publikation är en del av i anmärkningsfältet.  
